...
//    }
  ...
  stage('Push docker image') {
    sh "aws ecr get-login --region us-east-us --profile <profile name> | docker login -u AWS -p \$(aws ecr get-login-password --region us-east-2) 427380728300.dkr.ecr.us-east-2.amazonaws.com"
